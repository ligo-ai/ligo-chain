...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			name: 'signTransaction',
			call: 'ligo_signTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'submitTransaction',
			call: 'ligo_submitTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'getRawTransaction',
			call: 'ligo_getRawTransactionByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getRawTransactionFromBlock',
			call: function(args) {
				return (web3._extend.utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'ligo_getRawTransactionByBlockHashAndIndex' : 'ligo_getRawTransactionByBlockNumberAndIndex';
			},
			params: 2,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter, web3._extend.utils.toHex]
		}),
		new web3._extend.Method({
			name: 'getBalanceDetail',
			call: 'ligo_getBalanceDetail',
			params: 3,
			inputFormatter: [web3._extend.formatters.inputAddressFormatter, web3._extend.formatters.inputDefaultBlockNumberFormatter, null]
		}),
		new web3._extend.Method({
			name: 'signAddress',
			call: 'ligo_signAddress',
			params: 2
		}),
		new web3._extend.Method({
			name: 'getBlockReward',
			call: 'ligo_getBlockReward',
			params: 1
		}),
		new web3._extend.Method({
			name: 'withdrawReward',
			call: 'ligo_withdrawReward',
			params: 3,
			inputFormatter: [web3._extend.formatters.inputAddressFormatter, web3._extend.formatters.inputAddressFormatter, null]
		}),
		new web3._extend.Method({
			name: 'voteNextEpoch',
			call: 'ligo_voteNextEpoch',
			params: 3
		}),
		new web3._extend.Method({
			name: 'revealVote',
			call: 'ligo_revealVote',
			params: 6
		}),
		new web3._extend.Method({
			name: 'getCurrentEpochNumber',
			call: 'ligo_getCurrentEpochNumber'
		}),
		new web3._extend.Method({
			name: 'getEpoch',
			call: 'ligo_getEpoch',
		...
		new web3._extend.Method({
			...
			call: 'ligo_getNextEpochVote'
		}),
		new web3._extend.Method({
			name: 'getNextEpochValidators',
			call: 'ligo_getNextEpochValidators'
		}),
		new web3._extend.Method({
			name: 'getValidatorStatus',
			call: 'ligo_getValidatorStatus',
			params: 1,
		...
		new web3._extend.Method({
			name: 'unRegister',
			call: 'ligo_unRegister',
			params: 2
		}),
		new web3._extend.Method({
			name: 'checkCandidate',
			call: 'ligo_checkCandidate',
			params: 2,
			inputFormatter: [web3._extend.formatters.inputAddressFormatter, web3._extend.formatters.inputDefaultBlockNumberFormatter]
		}),
		new web3._extend.Method({
			name: 'getBannedStatus',
			call: 'ligo_getBannedStatus',
			params: 2,
			inputFormatter: [web3._extend.formatters.inputAddressFormatter, web3._extend.formatters.inputDefaultBlockNumberFormatter]
		}),
		new web3._extend.Method({
			name: 'setCommission',
			call: 'ligo_setCommission',
			params: 3,
