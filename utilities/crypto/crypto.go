...
func CreateAddress(b common.Address, nonce uint64) common.Address {
	...
	return common.StringToAddress(NewLigoScriptAddr(data))
}

func CreateAddress2(b common.Address, salt [32]byte, inithash []byte) common.Address {
	return common.BytesToAddress([]byte(NewLigoScriptAddr(Keccak256([]byte{0xff}, b.Bytes(), salt[:], inithash))))
}
...
func PubkeyToAddress(p ecdsa.PublicKey) common.Address {
	...
	return common.StringToAddress(NewLigoScriptAddr(pubBytes))
}
...
func NewLigoPubkeyAddr(pubkey []byte) string {
	input := Hash160(pubkey)

	return encodeAddress(input, pubkeyVersion)
}

func NewLigoScriptAddr(script []byte) string {
...
func ValidateLigoAddr(input string) bool {
