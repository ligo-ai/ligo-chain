...
import (
	...
	"github.com/ligo-ai/ligo-chain/chain/accounts/keystore"
	...
	"github.com/ligo-ai/ligo-chain/network/p2p"
	"github.com/ligo-ai/ligo-chain/network/p2p/discover"
	"github.com/ligo-ai/ligo-chain/network/p2p/nat"
	"github.com/ligo-ai/ligo-chain/network/p2p/netutil"
	"github.com/ligo-ai/ligo-chain/params"
	"github.com/ligo-ai/ligo-chain/utilities/common"
	"github.com/ligo-ai/ligo-chain/utilities/common/fdlimit"
	"github.com/ligo-ai/ligo-chain/utilities/crypto"
	"github.com/ligo-ai/ligo-chain/utilities/metrics"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		...
		Value: ligoprotocol.DefaultConfig.NetworkId,
	}
	...
	defaultSyncMode = ligoprotocol.DefaultConfig.SyncMode
	...
	TxPoolPriceLimitFlag = cli.Uint64Flag{
		...
		Value: ligoprotocol.DefaultConfig.TxPool.PriceLimit,
	}
	TxPoolPriceBumpFlag = cli.Uint64Flag{
		Name:  "txpool.pricebump",
		Usage: "Price bump percentage to replace an already existing transaction",
		Value: ligoprotocol.DefaultConfig.TxPool.PriceBump,
	}
	TxPoolAccountSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.accountslots",
		Usage: "Minimum number of executable transaction slots guaranteed per account",
		Value: ligoprotocol.DefaultConfig.TxPool.AccountSlots,
	}
	TxPoolGlobalSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.globalslots",
		Usage: "Maximum number of executable transaction slots for all accounts",
		Value: ligoprotocol.DefaultConfig.TxPool.GlobalSlots,
	}
	TxPoolAccountQueueFlag = cli.Uint64Flag{
		Name:  "txpool.accountqueue",
		Usage: "Maximum number of non-executable transaction slots permitted per account",
		Value: ligoprotocol.DefaultConfig.TxPool.AccountQueue,
	}
	TxPoolGlobalQueueFlag = cli.Uint64Flag{
		Name:  "txpool.globalqueue",
		Usage: "Maximum number of non-executable transaction slots for all accounts",
		Value: ligoprotocol.DefaultConfig.TxPool.GlobalQueue,
	}
	TxPoolLifetimeFlag = cli.DurationFlag{
		Name:  "txpool.lifetime",
		Usage: "Maximum amount of time non-executable transaction are queued",
		Value: ligoprotocol.DefaultConfig.TxPool.Lifetime,
	}
	...
	MinerGasTargetFlag = cli.Uint64Flag{
		...
		Value: ligoprotocol.DefaultConfig.MinerGasFloor,
	}
	MinerGasLimitFlag = cli.Uint64Flag{
		Name:  "miner.gaslimit",
		Usage: "Target gas ceiling for mined blocks",
		Value: ligoprotocol.DefaultConfig.MinerGasCeil,
	}
	MinerGasPriceFlag = BigFlag{
		Name:  "miner.gasprice",
		Usage: "Minimal gas price for mining a transactions",
		Value: ligoprotocol.DefaultConfig.MinerGasPrice,
	}
	...
	GpoBlocksFlag = cli.IntFlag{
		...
		Value: ligoprotocol.DefaultConfig.GPO.Blocks,
	}
	GpoPercentileFlag = cli.IntFlag{
		Name:  "gpopercentile",
		Usage: "Suggested gas price is the given percentile of a set of recent transaction gas prices",
		Value: ligoprotocol.DefaultConfig.GPO.Percentile,
	}
	...
	AddrFlag = cli.StringFlag{
		Name:  "addr",
		Value: "unix://@ligochainappunixsock",
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `ligochain account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func setCoinbase(ctx *cli.Context, ks *keystore.KeyStore, cfg *ligoprotocol.Config) {
	var coinbase string
...
func RegisterIntService(stack *node.Node, cfg *ligoprotocol.Config, cliCtx *cli.Context, cch core.CrossChainHelper) {
	...
	err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		fullNode, err := ligoprotocol.New(ctx, cfg, cliCtx, cch, stack.GetLogger(), cliCtx.GlobalBool(TestnetFlag.Name))
		return fullNode, err
	})
	if err != nil {
		Fatalf("Failed to register the ligochain service: %v", err)
	}
}

func MakeChainDatabase(ctx *cli.Context, stack *node.Node) ligodb.Database {
	var (
...
func MakeChain(ctx *cli.Context, stack *node.Node) (chain *core.BlockChain, chainDb ligodb.Database) {
	var err error
	...
	cache := &core.CacheConfig{
		TrieCleanLimit: ligoprotocol.DefaultConfig.TrieCleanCache,

		TrieDirtyLimit:    ligoprotocol.DefaultConfig.TrieDirtyCache,
		TrieDirtyDisabled: ctx.GlobalString(GCModeFlag.Name) == "archive",
		TrieTimeLimit:     ligoprotocol.DefaultConfig.TrieTimeout,
	}
	if ctx.GlobalIsSet(CacheFlag.Name) || ctx.GlobalIsSet(CacheTrieFlag.Name) {
