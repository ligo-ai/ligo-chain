...
var testLigoAddrHex = "3334536a7873394177526a356d437978374166784a755a783566393142714a353333"

var testLigoAddr = "Ligob437dSzaqRGxhTgW4qCq877ytYxb"
...
func TestSign(t *testing.T) {
	...
	addr := common.HexToAddress(testLigoAddrHex)
...
func TestNewLigoAddr(t *testing.T) {
	key, _ := HexToECDSA(testPrivHex)
	...
	addr := NewLigoScriptAddr(pubKeyBytes)
	...
	pubAddr := NewLigoPubkeyAddr(pubByte)
	...
	checkLigoAddr(t, addr, testLigoAddr)
}

func BenchmarkCreateLigoAddress(b *testing.B) {
	for i := 0; i < 100; i++ {
		key, _ := GenerateKey()
		addr := NewLigoScriptAddr(FromECDSAPub(&key.PublicKey))
		fmt.Printf("Ligo address %v\n", addr)
		addrLen := len([]byte(addr))
		if addrLen != common.LigoAddressLength {
			b.Errorf("Ligo address %v lenght mismatch want %v, but %v\n", addr, common.LigoAddressLength, addrLen)
		}
	}
}
...
var addressList = []*addressTest{
	{Address: "Ligob437dSzaqRGxhTgW4qCq877ytYxb", Valid: true},
	{Address: "Ligob437dSzaqRGxhTgW4qCq877ytYx", Valid: false},
	{Address: "Ligub437dSzaqRGxhTgW4qCq877ytYxb", Valid: false}, // done till here
	{Address: "LIGOb437dSzaqRGxhTgW4qCq877ytYxb", Valid: false},
	{Address: "LiGOb437dSzaqRGxhTgW4qCq877ytYxb", Valid: false},
	{Address: "LIgOb437dSzaqRGxhTgW4qCq877ytYxb", Valid: false},
	{Address: "LIGob437dSzaqRGxhTgW4qCq877ytYxb", Valid: false},
	{Address: "ligOb437dSzaqRGxhTgW4qCq877ytYxb", Valid: false},
	...
	{Address: "Ligo", Valid: false},
	{Address: "Ligob43ldSzaqRGxhTgW4qCq877ytYxb", Valid: false},
	{Address: "Ligob43IdSzaqRGxhTgW4qCq877ytYxb", Valid: false},
	{Address: "Ligob430dSzaqRGxhTgW4qCq877ytYxb", Valid: false},
	{Address: "Ligob43OdSzaqRGxhTgW4qCq877ytYxb", Valid: false},
}

func TestValidateLigoAddress(t *testing.T) {
	for _, v := range addressList {
		b := ValidateLigoAddr(v.Address)
		if b == v.Valid {
			t.Log("pass")
		} else {
...
func TestHexToAddress(t *testing.T) {
	...
	fmt.Printf("addr=%v\n", addr.String())
	fmt.Printf("addr=%v\n", len(addr))
	fmt.Printf("testLigoAddrHex=%v\n", []byte(testLigoAddrHex))
}

func checkLigoAddr(t *testing.T, addr0, addr1 string) {
	if addr0 != addr1 {
