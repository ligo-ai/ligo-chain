...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "lai", "eth")
	cfg.WSModules = append(cfg.WSModules, "lai", "eth")
	cfg.IPCPath = "ligochain.ipc"
	return cfg
}
...
func makeConfigNode(ctx *cli.Context, chainId string) (*node.Node, gethConfig) {
	...
	cfg := gethConfig{
		Eth:  ligoprotocol.DefaultConfig,
