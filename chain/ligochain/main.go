...
var (
	...
	app = utils.NewApp(gitCommit, "the ligochain command line interface")
...
func init() {
	...
	app.Action = ligochainCmd
	app.HideVersion = true
	app.Copyright = "Copyright 2023 Ligo AI Developers"
