...
var (
	walletCommand = cli.Command{
		...
		Description: `
    ligochain wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	ligochain wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    ligochain account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    ligochain account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    ligochain account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    ligochain account import [options] <keyfile>
...
func accountList(ctx *cli.Context) error {
	...
	if ctx.GlobalIsSet(utils.TestnetFlag.Name) {
		fmt.Printf("testnet: %v\n", params.TestnetChainConfig.LigoChainId)
...
func accountCreate(ctx *cli.Context) error {
	...
	cfg.Node.ChainId = params.MainnetChainConfig.LigoChainId

	if ctx.GlobalIsSet(utils.TestnetFlag.Name) {
		fmt.Printf("testnet: %v\n", params.TestnetChainConfig.LigoChainId)
		cfg.Node.ChainId = params.TestnetChainConfig.LigoChainId
	}
