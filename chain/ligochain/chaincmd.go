...
import (
	...
	"github.com/ligo-ai/ligo-chain/utilities/console"
...
var (
	initLigoGenesisCmd = cli.Command{
		Action:    utils.MigrateFlags(initLigoGenesis),
		Name:      "init-ligo-chain",
		Usage:     "Initialize Ligo AI genesis.json file. init-ligo-chain {\"1000000000000000000000000000\",\"100000000000000000000000\"}",
		ArgsUsage: "<genesisPath>",
		Flags: []cli.Flag{
			utils.DataDirFlag,
		},
		Category:    "BLOCKCHAIN COMMANDS",
		Description: "The init-ligo-chain initializes a new Ligo AI genesis.json file for the network.",
	}
...
It expects the genesis file as argument.`,
	...
	initSideChainCmd = cli.Command{
		...
		Usage:       "ligochain --sideChain=side_0,side_1,side_2 init-side-chain",
...
func countTrie(db ligodb.Database, t state.Trie, count *CountSize, processLeaf processLeafTrie) {
...
func version(ctx *cli.Context) error {
	...
	fmt.Println("Protocol Versions:", ligoprotocol.ProtocolVersions)
