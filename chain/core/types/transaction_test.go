...
func TestNewTransactionJSON(t *testing.T) {
	...
	//switch i % 2 {
	//case 0:
	tx = NewTransaction(0, common.StringToAddress("LigotWX5FxpBddhwxzde47H7dWorB6AA"), big.NewInt(1000000000000000000), 30000, big.NewInt(20000000000), []byte("0x"))
	//case 1:
	//	tx = NewContractCreation(i, common.Big0, 1, common.Big2, []byte("abcdef"))
	//}
...
func TestSignTx(t *testing.T) {
	...
	address := common.StringToAddress("LigotWX5FxpBddhwxzde47H7dWorB6AA")
...
func TestDelegateTx(t *testing.T) {
	...
	signer := NewEIP155Signer(common.Big2) // mainnet 1，testnet 2
	//address := common.StringToAddress("LigoAIMiningSmartContractAddress")
	address := common.StringToAddress("LigoAIMiningSmartContractAddress")

	input, err := ligoAbi.ChainABI.Pack(ligoAbi.Delegate.String(), common.StringToAddress("LigoAIMiningSmartContractAddress"))
