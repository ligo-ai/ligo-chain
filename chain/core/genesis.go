...
func (g *Genesis) ToBlock(db ligodb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db ligodb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db ligodb.Database) *types.Block {
...
func GenesisBlockForTesting(db ligodb.Database, addr common.Address, balance *big.Int) *types.Block {
