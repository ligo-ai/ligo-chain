...
type PruneProcessor struct {
	db      ligodb.Database // Low level persistent database to store prune counting statistics
	prunedb PruneDatabase

	bc      *core.BlockChain
	chainDb ligodb.Database // database instance to delete the state/block data
