...
func makeHeader(chain consensus.ChainReader, parent *types.Block, state *state.StateDB, engine consensus.Engine) *types.Header {
	...
	if parent.Time() == 0 {
		...
		time = new(big.Int).SetUint64(parent.Time() + 10) // block time is fixed at 10 seconds
	}
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Engine, db ligodb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Engine, db ligodb.Database, seed int) []*types.Block {
