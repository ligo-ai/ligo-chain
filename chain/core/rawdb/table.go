...
func NewTable(db ligodb.Database, prefix string) ligodb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator() ligodb.Iterator {
	return t.NewIteratorWithPrefix(nil)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (t *table) NewIteratorWithPrefix(prefix []byte) ligodb.Iterator {
...
func (t *table) NewBatch() ligodb.Batch {
...
func (b *tableBatch) Replay(w ligodb.Writer) error {
