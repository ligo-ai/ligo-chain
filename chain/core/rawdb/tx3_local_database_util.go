...
import (
	...
	"github.com/ligo-ai/ligo-chain/chain/trie"
...
func GetTX3(db ligodb.Reader, chainId string, txHash common.Hash) *types.Transaction {
...
func GetTX3ProofData(db ligodb.Reader, chainId string, txHash common.Hash) *types.TX3ProofData {
...
func GetTX3LookupEntry(db ligodb.Reader, chainId string, txHash common.Hash) (common.Hash, uint64, uint64) {
...
func GetAllTX3ProofData(db ligodb.Database) []*types.TX3ProofData {
...
func WriteTX3ProofData(db ligodb.Database, proofData *types.TX3ProofData) error {
	header := proofData.Header
...
func WriteTX3(db ligodb.Writer, chainId string, header *types.Header, txIndex uint, txProofData *types.BSKeyValueSet) error {
...
func DeleteTX3(db ligodb.Database, chainId string, txHash common.Hash) {
	// Retrieve the lookup metadata
	hash, blockNumber, txIndex := GetTX3LookupEntry(db, chainId, txHash)
	if hash == (common.Hash{}) {
		return
