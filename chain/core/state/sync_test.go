...
// account array.
func checkStateAccounts(t *testing.T, db ligodb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ligodb.Database, root common.Hash) error {
...
func checkStateConsistency(db ligodb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(ligodb.Database), srcRoot)
