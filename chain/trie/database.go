...
func NewDatabase(diskdb ligodb.KeyValueStore) *Database {
	return NewDatabaseWithCache(diskdb, 0)
}

func NewDatabaseWithCache(diskdb ligodb.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() ligodb.Reader {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch ligodb.Batch, uncacher *cleaner) error {
