...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ligochain.ipc", false, filepath.Join(os.TempDir(), "ligochain.ipc")},
		{"data", "ligochain.ipc", false, "data/ligochain.ipc"},
		{"data", "./ligochain.ipc", false, "./ligochain.ipc"},
		{"data", "/ligochain.ipc", false, "/ligochain.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ligochain.ipc", true, `\\.\pipe\ligochain.ipc`},
		{"data", "ligochain.ipc", true, `\\.\pipe\ligochain.ipc`},
		{"data", `\\.\pipe\ligochain.ipc`, true, `\\.\pipe\ligochain.ipc`},
	}
