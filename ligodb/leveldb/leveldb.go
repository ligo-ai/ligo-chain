...
func (db *Database) NewBatch() ligodb.Batch {
	return &batch{
		db: db.db,
		b:  new(leveldb.Batch),
	}
...
func (db *Database) NewIterator() ligodb.Iterator {
	return db.NewIteratorWithPrefix(nil)
}

func (db *Database) NewIteratorWithPrefix(prefix []byte) ligodb.Iterator {
...
func (b *batch) Replay(w ligodb.Writer) error {
	return b.b.Replay(&replayer{writer: w})
}

type replayer struct {
	writer  ligodb.Writer
	failure error
}
