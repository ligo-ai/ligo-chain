...
var SideChainTokenIncentiveAddr = common.StringToAddress("LigoAISideChainsTokenDepositAddy")

var ChainContractMagicAddr = common.StringToAddress("LigoAIMiningSmartContractAddress")
...
func IsLigoChainContractAddr(addr *common.Address) bool {
