...
func WriteGenesisBlock(chainDb ligodb.Database, reader io.Reader) (*types.Block, error) {
...
func SetupGenesisBlockEx(db ligodb.Database, genesis *Genesis) (*types.Block, error) {
...
func SetupGenesisBlockWithDefault(db ligodb.Database, genesis *Genesis, isMainChain, isTestnet bool) (*params.ChainConfig, common.Hash, error) {
	if genesis != nil && genesis.Config == nil {
...
var DefaultMainnetGenesisJSON = `{                                                                                                                                                                                            
	...
	"alloc": {
			"LigoxdFbo7zsqQqr829U9p7rFja1ZGyk": {
...
var DefaultTestnetGenesisJSON = `{
	...
	"coinbase": "LigoAIBlockchainsGenesisCoinbase",
	"alloc": {
			"LigojQoTmRNypoWaTpMebKmED8bbA32b": {
					"balance": "0x3ee1186f11c064cc00000",
					"amount": "0x104e2da94483f6200000"
			}
	},
