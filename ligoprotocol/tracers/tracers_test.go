...
var makeTest = function(tx, rewind) {
  ...
  var block   = ligoprotocol.getBlock(ligoprotocol.getTransaction(tx).blockHash);
  var genesis = ligoprotocol.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.ligoprotocol.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  ligoprotocol.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
