...
type subscription struct {
	...
	typ       Type
	created   time.Time
	logsCrit  ligochain.FilterQuery
	logs      chan []*types.Log
...
func (es *EventSystem) subscribeMinedPendingLogs(crit ligochain.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribeLogs(crit ligochain.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribePendingLogs(crit ligochain.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
