...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(ligochain.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(ligochain.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
func decodeAddress(s string) (common.Address, error) {
	...
	if err == nil && len(b) != common.LigoAddressLength {
